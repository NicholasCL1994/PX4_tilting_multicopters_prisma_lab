...
#define CONFIG_BOARD_SERIAL_TEL4 "/dev/ttyS3"
...
#define CONFIG_COMMON_HYGROMETERS 1
#define CONFIG_DRIVERS_HYGROMETER_SHT3x 1
...
#define CONFIG_BOARD_UAVCAN_TIMER_OVERRIDE 6
